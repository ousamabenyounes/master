...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'agentpanelpro.cqdryledgmly.us-west-2.rds.amazonaws.com', 'port' => 3306, 'dbname' => 'agent_panel_pro', 'user' => 'agentpanelpro', 'password' => 'agentpanelpro', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
