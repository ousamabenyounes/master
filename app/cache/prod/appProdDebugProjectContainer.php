...
class appProdDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'usermanage_service' => 'getUsermanageServiceService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'agentpanelpro.cqdryledgmly.us-west-2.rds.amazonaws.com', 'port' => 3306, 'dbname' => 'agent_panel_pro', 'user' => 'agentpanelpro', 'password' => 'agentpanelpro', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Users/UserManageBundle/Entity'))), 'Users\\UserManageBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('UsersUserManageBundle' => 'Users\\UserManageBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d9e595e995780b6889061f70a8f5e9ee2059e9b7793e60da5aa2d4fd5c5200cd');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('sachin.agarwal.aws@gmail.com');
        $a->setPassword('sachin#123');
        $a->setAuthMode('login');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'TrsteelCkeditorBundle:Form:ckeditor_widget.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Users/UserManageBundle/Resources/views'), 'UsersUserManage');
        $instance->addPath(($this->targetDirs[3].'/src/testing/testingBundle/Resources/views'), 'testingtesting');
        $instance->addPath(($this->targetDirs[3].'/src/Trsteel/CkeditorBundle/Resources/views'), 'TrsteelCkeditor');
    ...
    /**
     * Gets the 'usermanage_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Users\UserManageBundle\DependencyInjection\UsermanageService A Users\UserManageBundle\DependencyInjection\UsermanageService instance.
     */
    protected function getUsermanageServiceService()
    {
        return $this->services['usermanage_service'] = new \Users\UserManageBundle\DependencyInjection\UsermanageService($this->get('doctrine.orm.default_entity_manager'), 15, 0, 2, 'f3f1f1', 434445, '14px');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'UsersUserManageBundle' => 'Users\\UserManageBundle\\UsersUserManageBundle',
                'testingtestingBundle' => 'testing\\testingBundle\\testingtestingBundle',
            ...
            'database_host' => 'agentpanelpro.cqdryledgmly.us-west-2.rds.amazonaws.com',
            'database_port' => 3306,
            'database_name' => 'agent_panel_pro',
            'database_user' => 'agentpanelpro',
            'database_password' => 'agentpanelpro',
            'mailer_transport' => 'gmail',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'sachin.agarwal.aws@gmail.com',
            'mailer_password' => 'sachin#123',
            'locale' => 'en',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'sachin.agarwal.aws@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'sachin#123',
